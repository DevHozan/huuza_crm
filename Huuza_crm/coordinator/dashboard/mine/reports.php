...
$reports =$mainmanager->fetchAll('reports_view');
...
<div class="col-lg-12">
  <div class="filter_form">
    ...
    <input type="text" id="search_input" placeholder="Search any column...">
  </div>
</div>
  <div class="card">
    <div class="card-body">
...
<script>
  ...
  document.getElementById('search_input').addEventListener('input', function() {
    ...
    rows.forEach(function(row) {
      ...
      let match = Array.from(row.cells).some(function(cell) {
