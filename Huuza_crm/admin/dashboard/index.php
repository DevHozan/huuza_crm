...
$total_users=$mainmanager->fetchSumAndCount('users','UserID');
$total_reports=$mainmanager->fetchSumAndCount('reports','ReportID');
?>
<!DOCTYPE html>
<html lang="en">
...
<body>
    ...
    <div class="pagetitle">
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="index.html">Leads</a></li>
          ...
          <div class="row">
            ...
            <div class="col-xxl-4 col-md-6">
              <div class="card info-card revenue-card">
                ...
                <div class="card text-center">
                  <div class="card-body">
                      <h5 class="card-title">Numbers Users</h5>
                      <div class="d-flex align-items-center justify-content-center">
                          <div class="card-icon bg-success text-white rounded-circle d-flex align-items-center justify-content-center" style="width: 50px; height: 50px;">
                              <i class="bi bi-person-check" style="font-size: 24px;"></i> <!-- Icon for hired candidates -->
                          </div>
                          <div class="ps-3">
                              <h6><?= $total_users['total_count']?></h6>
                          </div>
                      </div>
                  </div>
              </div>
                ...
                <div class="card-body">
                  ...
                  <div class="d-flex align-items-center">
                    <div class="card-icon rounded-circle d-flex align-items-center justify-content-center">
                      <i class="bi bi-hourglass-split"></i> <!-- Represents pending jobs or waiting -->

                    </div>
                    <div class="ps-3">
                      <h6><?=$total_reports['total_count'] ?></h6>
            ...
            <div class="col-12">
              <div class="card">
                ...
                <div class="card-body">
                  <h5 class="card-title">Leads status distribution</h5>
            ...
            <div class="col-12">
              <div class="card">
                ...
                <div class="card-body">
                  <h5 class="card-title">Agent Activity overview</h5>
  ...
  <footer id="footer" class="footer">
    ...
    <div class="credits">
      ...
      Designed by <a href="">IT Officer</a>
    </div>
  </footer><!-- End Footer -->
