...
$table='view_users';
$users=$mainmanager->fetchAllOnRole($table,'coordinator');
                ...
                <?php foreach($users as $user): ?>
                        ...
                        <div class="btn-group" role="group">
                            ...
                            <button type="submit" name="approve" value="<?php echo $user['UserID']; ?>" class="btn btn-success">Approve</button>
                                  ...
                                  <!-- Update Action -->
                                  <button type="submit" name="reject_payments" value="<?php echo $user['UserID']; ?>" class="btn btn-warning">Reject</button>
