...
<body>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <li class="nav-item">
        <a class="nav-link" href="add_officers.php">
            <i class="bi bi-person-badge"></i> <!-- Officers Icon -->
            <span>Coordinator</span>
        </a>
    </li>
    
    <li class="nav-item">
        <a class="nav-link" href="representatives.html">
            <i class="bi bi-people"></i> <!-- Representatives Icon -->
            <span>Representatives</span>
        </a>
    </li>
    
    <li class="nav-item">
        <a class="nav-link" href="sales_agent.html">
            <i class="bi bi-person-lines-fill"></i> <!-- Sales Agent Icon -->
    ...
    <li class="nav-item">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="dashboard/login.php">
  ...
  <footer id="footer" class="footer">
    ...
    <div class="credits">
      ...
      Designed by <a href="https://bootstrapmade.com/">IT Officer</a>
    </div>
  </footer><!-- End Footer -->
